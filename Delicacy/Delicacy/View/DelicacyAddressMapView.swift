...
class DelicacyAddressMapView: UIView, MKMapViewDelegate {
    ...
    private func subviewInit() {
        Bundle.main.loadNibNamed("DelicacyAddressMapView", owner: self, options: nil)
